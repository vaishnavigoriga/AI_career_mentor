        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Our AI-powered platform creates personalized career roadmaps tailored to your unique profile and goals.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-slate-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl mx-auto mb-4 flex items-center justify-center">
                  <Target className="w-8 h-8 text-blue-600" />
                </div>
                <CardTitle className="text-xl text-slate-800">Share Your Goals</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-slate-600">
                  Tell us about your education, skills, and career interests. Our AI analyzes your profile to understand your unique situation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-slate-800">AI Creates Roadmap</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-slate-600">
                  Our advanced AI generates a personalized career roadmap with phases, learning resources, and project ideas tailored to you.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-slate-800">Follow & Succeed</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-slate-600">
                  Follow your personalized roadmap, complete projects, and track your progress towards your dream career.
                </p>
              </CardContent>
            </Card>
          </div>
